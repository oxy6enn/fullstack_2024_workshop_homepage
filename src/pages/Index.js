...
function Index() {
    ...
    const [carts, setCarts] = useState([]) // Items in Cats
    ...
    const handleRemove = async (item) => {
        try {
            const button = await Swal.fire({
                title: 'ลบสินค้า',
                text: 'คุณต้องการลบสินค้าออกจากจะกร้าหรือไม่?',
                icon: 'question',
            ...
            if (button.isConfirmed) {
                ...
                //คำนวณราคาใหม่หลังจากไอเทมจากตะกร้า
        ...
        <div className='container-fluid mt-3'>
            ...
            <div className='row'>
                {products.length > 0 ? products.map(item =>
                    <div className='col-xl-3 col-sm-4 mt-3' key={item.id}>
                        <div className='card'>
                            {showImage(item)}
        ...
        <MyModal id='modalCart' title='ตะกร้าสินค้าของฉัน'>
            ...
            <div className='mt-3'>
                <div className='alert alert-info text-center'>
                    ...
                    <div>ไทยพาณิชย์ นายทดสอบ ระบบ 111-222-333-444</div>
                </div>
                <div>
                    <div>ชื่อผู้ซื้อ</div>
                ...
                <button className='btn btn-primary mt-3' onClick={handleSave}>
                    <i className='fa fa-check mr-3'></i>ยืนยันการซื้อ
                </button>
                </div>
